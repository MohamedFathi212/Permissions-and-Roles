                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div class="mb-6">
                            ...
                            <input placeholder="Enter Title" name="title" id="title" value="{{ old('title') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea placeholder="Enter Content" name="text" id="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-black" cols="30" rows="10">{{ old('text') }}</textarea>
                            @error('text')
                                <p class="text-red-400 font-medium mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input placeholder="Enter Author" name="author" id="author" value="{{ old('author') }}"
                                   type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-black">
                            @error('author')
                                <p class="text-red-400 font-medium mt-1">{{ $message }}</p>
                            @enderror
