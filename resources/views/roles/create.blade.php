                    ...
                    <form action="{{ route('roles.store') }}" method="post">
                        ...
                        <div class="grid grid-cols-4 mb-3">
                            @if($permissions->isNotEmpty())
                                ...
                                <div class="mt-3">
                                    <input  id="permission-{{ $permission->id }}" type="checkbox" class="rounded" name="permission[]"
                            ...
                            <button class="bg-slate-500 hover:bg-slate-500 text-sm rounded-md text-white px-5 py-3">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
